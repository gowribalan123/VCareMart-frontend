...
export const SellerHeader = () => {
    ...
    return (
        <div className="flex justify-between items-center w-full px-10 h-24 bg-black shadow-lg border-b border-gray-700">
            <Link to="/" className="flex items-center">
                <div className="text-4xl font-bold text-blue-500 hover:text-blue-400 transition duration-300">VCare</div>
            </Link>
            
            <nav className="flex gap-10 items-center font-semibold text-gray-300">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    <DarkMode />
                    <Link to="/seller/cart" className="hover:text-blue-500 transition duration-300">
